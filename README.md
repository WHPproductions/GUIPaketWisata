...
Aplikasi GUI desktop untuk mengelola paket wisata/tur di Indonesia. Ini adalah aplikasi industri pariwisata yang ditulis dalam Java menggunakan Swing untuk antarmuka pengguna.

## Tipe Sistem:
- Aplikasi CRUD (Buat, Baca, Perbarui, Hapus)
- Klien Desktop dengan GUI (Antarmuka Pengguna Grafis)
- Data Struktur OOP (Pewarisan, antarmuka, Polimorfisme, dll.)
...
- Efek hover responsif pada tombol
